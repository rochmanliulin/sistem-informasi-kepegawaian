                    ...
                    <div class="row">
                        <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column mx-lg-0 mx-auto">
                            <div class="card card-plain">
                                <div class="card-header pb-0 text-start">
                                    ...
                                    <p class="mb-0">Masukkan email Anda dan harap tunggu</p>
                                </div>
                                <div class="card-body">
                        ...
                        <div
                            ...
                            <div class="position-relative bg-gradient-primary h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center overflow-hidden"
                                ...
                                <h4 class="mt-5 text-white font-weight-bolder position-relative">"Password is Privacy"</h4>
                                <p class="text-white position-relative">Tidak semua hal dari diri kita diketahui oleh orang lain.</p>
                            </div>
                        </div>
                    </div>
                </div>
