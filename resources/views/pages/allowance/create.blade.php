								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="number" class="form-control" id="gajiPokok" placeholder="Nominal Gaji" name="gaji_harian"/>
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="number" class="form-control" id="premiHadir" placeholder="Nominal Premi Hadir" name="premi_hadir_harian"/>
							...
							<div id="pegawaiKontrak" style="display: {{ $errors->has('gaji_bulanan') || $errors->has('kos') || $errors->has('masuk_pagi') || $errors->has('prestasi') || $errors->has('komunikasi') || $errors->has('jabatan') || $errors->has('lain_lain') || $errors->has('uang_makan') || $errors->has('kasbon') || $errors->has('premi_hadir_bulanan') || $errors->has('premi_lembur') || $errors->has('doa') ? 'block' : 'none' }}">
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											<label for="gajiPokok" class="form-control-label">Gaji Pokok</label>
											<input type="number" class="form-control" id="gajiPokok" placeholder="Nominal Gaji Pokok" name="gaji_bulanan"/>
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="number" class="form-control" id="kos" placeholder="Nominal Tunjangan Kos" name="kos"/>
								...
								<div class="row">
									<div class="col-md-2">
										<div class="form-group">
											...
											<input type="number" class="form-control" id="masukPagi" placeholder="Nominal Masuk Pagi" name="masuk_pagi"/>
									...
									<div class="col-md-2">
										<div class="form-group">
											...
											<input type="number" class="form-control" id="prestasi" placeholder="Nominal Prestasi" name="prestasi"/>
									...
									<div class="col-md-2">
										<div class="form-group">
											...
											<input type="number" class="form-control" id="komunikasi" placeholder="Nominal Komunikasi" name="komunikasi"/>
									...
									<div class="col-md-2">
										<div class="form-group">
											...
											<input type="number" class="form-control" id="jabatan" placeholder="Nominal Jabatan" name="jabatan"/>
									...
									<div class="col-md-2">
										<div class="form-group">
											...
											<input type="number" class="form-control" id="lainLain" placeholder="Nominal Lain-Lain" name="lain_lain"/>
									...
									<div class="col-md-2">
										<div class="form-group">
											...
											<input type="number" class="form-control" id="uangMakan" placeholder="Nominal Uang Makan" name="uang_makan"/>
								...
								<div class="row">
									<div class="col-md-3">
										<div class="form-group">
											...
											<input type="number" class="form-control" id="kasbon" placeholder="Nominal Kasbon" name="kasbon"/>
									...
									<div class="col-md-3">
										<div class="form-group">
											<label for="premiHadir" class="form-control-label">Premi Hadir</label>
											<input type="number" class="form-control" id="premiHadir" placeholder="Nominal Premi Hadir" name="premi_hadir_bulanan"/>
									...
									<div class="col-md-3">
										<div class="form-group">
											...
											<input type="number" class="form-control" id="premiLembur" placeholder="Nominal Premi Lembur" name="premi_lembur"/>
									...
									<div class="col-md-3">
										<div class="form-group">
											...
											<input type="number" class="form-control" id="doa" placeholder="Nominal Hadir Do'a" name="doa"/>
