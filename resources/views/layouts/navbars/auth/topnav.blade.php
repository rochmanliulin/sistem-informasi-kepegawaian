    ...
    <div class="container-fluid py-1 px-3">
        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
            ...
            <ul class="navbar-nav flex-grow-1 justify-content-end">
                <span class="me-4 text-white fw-bold d-none d-lg-block">Welcome back,</span>
                <li class="nav-item dropdown me-3 d-flex">
                    <a href="javascript:;" class="nav-link text-white p-0 d-flex align-items-center fw-bold fs-6" id="userDropdown" data-bs-toggle="dropdown" aria-expanded="false">
