...
class FingerprintController extends Controller
{
    ...
    public function update(Request $request, string $id)
    {
        ...
        $validated = $request->validate([
            ...
            'scan_masuk' => 'nullable|date_format:H:i:s',
            'terlambat' => 'required|integer',
            'scan_istirahat_1' => 'nullable|date_format:H:i:s',
            'scan_istirahat_2' => 'nullable|date_format:H:i:s',
            'istirahat' => 'required|integer',
            'scan_pulang' => 'nullable|date_format:H:i:s',
            'durasi' => 'required|integer',
            'lembur_akhir' => 'required|integer'
        ]);
